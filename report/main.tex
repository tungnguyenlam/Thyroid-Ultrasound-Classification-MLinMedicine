% =========================================================
%  Thyroid Ultrasound Classification — IEEE Conference Paper
%  Converted from Typst (main.typ) to LaTeX
...
% IEEEtran already handles two-column; for spanning figures use figure*
\graphicspath{{figs/}}
...
\medskip
Thyroid cancer is one of the most common endocrine malignancies worldwide, and timely
...
assessment, yet manual interpretation remains subjective, operator-dependent, and
labor-intensive.
...
The recently released TN5000 dataset~\cite{zhang2025tn5000} provides a biopsy-confirmed
...
strong training pipeline incorporating Mixup augmentation, Test-Time Augmentation (TTA), and a
